...
Part 1 Q1: The output would see parentchild on almost every line for each variant except printf without any flush (childparent)

Part1 Q2: Adding a sleep instruction in the write variant makes the program TRYWITH0.1s
